<template>
  <div class="questionnaire-container">
    <div class="type-don">
      ...
      <div class="options">
        <label><input type="radio" name="don" checked />Sanguin</label>
        <label><input type="radio" name="don" />Organe</label>
        <label><input type="radio" name="don" />Foie</label>
      </div>
    </div>
    ...
    <div class="carte">
      ...
      <button class="btn-submit">M'inscrire</button>
     </div>
  </div>
</template>
